...
weekend.dt <- days.dt[day.of.the.week %in% c("Sam", "Dim"),]
...
viz <-
  list(##bars=bars+guides(fill="none"),
    ...
    source="https://github.com/tdhock/montreal-velos/blob/2e4878295cf5886061b781e5eba018d275bdfd74/figure-timeseries.R")
